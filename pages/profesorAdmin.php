                            ...
                            <table class="table table-striped table-bordered table-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <?php
                                            echo "<a class='btn btn-default'  href='formularioProfesorEditar.php?id=".$c->getId_profesor()."'   ><em class='fa fa-pencil'></em></a>";
                                            ?>
                                            
                                            <?php
                                            echo "<a class='btn btn-danger' href='profesorEliminar.php?id=".$c->getId_profesor()."'><em class='fa fa-trash'></em></a>";  
                                            ?>
                                        </td>
                                        <td class="hidden-xs">  <?php  echo $c->getId_profesor();    ?>   </td>
