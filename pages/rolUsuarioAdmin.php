...
echo "<h2 class='texcen'>Bienvenido Rol Usuario Administrador:(".$_SESSION['MiSession'].") </h2>";
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Listado de Rol Usuarios</h3>
                  </div>
                  <div class="col col-xs-6 text-right">
                     ...
                     <?php
                         ...
                         echo " <a type='button' class='btn btn-sm btn-primary btn-create' href= 'formulariorolUsuarioInsertar.php' >Crear Nuevo</a> ";
                        ...
                        ?>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              echo "<a class='btn btn-default'  href='formulariorolUsuarioEditar.php?id=".$c->getIdRolUsuario()."'   ><em class='fa fa-pencil'></em></a>";
                              ...
                              echo "<a class='btn btn-danger' href='rolUsuarioEliminar.php?id=".$c->getIdRolUsuario()."'><em class='fa fa-trash'></em></a>";  
                            ...
                            <td class="hidden-xs">  <?php  echo $c->getIdRolUsuario();    ?>   </td>
