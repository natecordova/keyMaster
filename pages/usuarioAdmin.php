                ...
                <div class="row">
                  ...
                  <div class="col col-xs-6 text-right">
                     ...
                     <?php
                         ...
                         echo " <a type='button' class='btn btn-sm btn-primary btn-create' href= 'formularioUsuarioInsertar.php' >Crear Nuevo</a> ";
                        ...
                        ?>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              echo "<a class='btn btn-default'  href='formularioUsuarioEditar.php?id=".$c->getIdUsuario()."'   ><em class='fa fa-pencil'></em></a>";
                              ...
                              echo "<a class='btn btn-danger' href='usuarioEliminar.php?id=".$c->getIdUsuario()."'><em class='fa fa-trash'></em></a>";  
                            ...
                            <td class="hidden-xs">  <?php  echo $c->getIdUsuario();    ?>   </td>
