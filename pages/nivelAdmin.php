                ...
                <div class="row">
                  ...
                  <div class="col col-xs-6 text-right">
                     ...
                     <?php
                         ...
                         echo " <a type='button' class='btn btn-sm btn-primary btn-create' href= 'formularioNivelInsertar.php' >Crear Nuevo</a> ";
                        ...
                        ?>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              echo "<a class='btn btn-default'  href='formularioNivelEditar.php?id=".$c->getIdNivel()."'   ><em class='fa fa-pencil'></em></a>";
                              ...
                              echo "<a class='btn btn-danger' href='nivelEliminar.php?id=".$c->getIdNivel()."'><em class='fa fa-trash'></em></a>";  
                            ...
                            <td class="hidden-xs">  <?php  echo $c->getIdNivel();    ?>   </td>
