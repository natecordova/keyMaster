              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Listado de Tipos de cancelacion</h3>
                  </div>
                  <div class="col col-xs-6 text-right">
                     ...
                     <?php
                         ...
                         echo " <a type='button' class='btn btn-sm btn-primary btn-create' href= 'formularioTipo_cancelacionInsertar.php' >Crear Nuevo</a> ";
                        ...
                        ?>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              echo "<a class='btn btn-default'  href='formularioTipo_cancelacionEditar.php?id_tipo_cancelacion=".$c-> getIdTipo_cancelacion()."'   ><em class='fa fa-pencil'></em></a>";
                              ...
                              echo "<a class='btn btn-danger' href='tipo_cancelacionEliminar.php?id_tipo_cancelacion=".$c->getIdTipo_cancelacion()."'><em class='fa fa-trash'></em></a>";  
                            ...
                            <td class="hidden-xs">  <?php  echo $c->getIdTipo_cancelacion();    ?>   </td>
