                ...
                <div class="row">
                  ...
                  <div class="col col-xs-6 text-right">
                     ...
                     <?php
                         ...
                         echo " <a type='button' class='btn btn-sm btn-primary btn-create' href= 'formularioHorarioInsertar.php' >Crear Nuevo</a> ";
                        ...
                        ?>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              echo "<a class='btn btn-default'  href='formularioHorarioEditar.php?id_horario=".$c->getIdHorario()."'   ><em class='fa fa-pencil'></em></a>";
                              ...
                              echo "<a class='btn btn-danger' href='horarioEliminar.php?id_horario=".$c->getIdHorario()."'><em class='fa fa-trash'></em></a>";  
                            ...
                            <td class="hidden-xs">  <?php  echo $c->getIdHorario();    ?>   </td>
                            

                             <td> <?php echo  $c->getHoraInicio(); ?> </td>
                             
                             <td> <?php echo  $c->getHoraFinal(); ?> </td>
                            
                             <td> <?php echo  $c->getIdCursoFk(); ?> </td>
